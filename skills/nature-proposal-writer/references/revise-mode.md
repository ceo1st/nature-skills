...
Use when JL provides existing proposal text, a paper/proposal section, or a full research plan draft.
...
**Input**: the full text JL provides (paragraph, section, or full document).
...
- If JL provides a single section from a larger document, ask: "这是完整 proposal 还是其中一节？需要我对照全文审查还是只看这一节？"
...
| "Mg 纯化可降低腐蚀速率" | Canon says: "Gong 2022: Mg reduces corrosion in ternary" | evidence-backed | OK — claim is supported and within scope |
